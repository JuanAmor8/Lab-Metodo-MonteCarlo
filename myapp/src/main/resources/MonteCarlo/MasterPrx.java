...
{
    default float estimatePi(int totalPoints, int numWorkers)
    {
        return estimatePi(totalPoints, numWorkers, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float estimatePi(int totalPoints, int numWorkers, java.util.Map<String, String> context)
    {
        return _iceI_estimatePiAsync(totalPoints, numWorkers, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> estimatePiAsync(int totalPoints, int numWorkers)
    {
        return _iceI_estimatePiAsync(totalPoints, numWorkers, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> estimatePiAsync(int totalPoints, int numWorkers, java.util.Map<String, String> context)
    {
        return _iceI_estimatePiAsync(totalPoints, numWorkers, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_estimatePiAsync(int iceP_totalPoints, int iceP_numWorkers, java.util.Map<String, String> context, boolean sync)
    {
