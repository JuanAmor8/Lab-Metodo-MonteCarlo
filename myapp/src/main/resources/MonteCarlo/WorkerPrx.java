...
{
    default int countPointsInCircle(int pointsToGenerate)
    {
        return countPointsInCircle(pointsToGenerate, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int countPointsInCircle(int pointsToGenerate, java.util.Map<String, String> context)
    {
        return _iceI_countPointsInCircleAsync(pointsToGenerate, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> countPointsInCircleAsync(int pointsToGenerate)
    {
        return _iceI_countPointsInCircleAsync(pointsToGenerate, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> countPointsInCircleAsync(int pointsToGenerate, java.util.Map<String, String> context)
    {
        return _iceI_countPointsInCircleAsync(pointsToGenerate, context, false);
    }

    /**
     * @hidden
     * @param iceP_pointsToGenerate -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_countPointsInCircleAsync(int iceP_pointsToGenerate, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "countPointsInCircle", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_pointsToGenerate);
                 }, istr -> {
                     int ret;
                     ret = istr.readInt();
                     return ret;
